...
from app.models.models import Base #Almebic needs access to base, aka the thing that creates tables
...
target_metadata = Base.metadata #replace with base.metadata
